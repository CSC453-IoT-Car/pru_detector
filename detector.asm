...
;* Date/Time created: Fri Apr 13 04:23:56 2018                                *
;******************************************************************************
...
$C$DW$6	.dwtag  DW_TAG_variable, DW_AT_name("GPIO1_CLEAR")
	...
	.dwattr $C$DW$6, DW_AT_decl_file("detector.c")
...
$C$DW$7	.dwtag  DW_TAG_variable, DW_AT_name("GPIO1_SET")
	...
	.dwattr $C$DW$7, DW_AT_decl_file("detector.c")
...
$C$DW$8	.dwtag  DW_TAG_variable, DW_AT_name("decay")
	...
	.dwattr $C$DW$8, DW_AT_decl_file("detector.c")
	.dwattr $C$DW$8, DW_AT_decl_line(0x49)
	.dwattr $C$DW$8, DW_AT_decl_column(0x0b)
;	optpru /tmp/02366OwuX0y /tmp/02366qczfMX 
;	acpiapru -@/tmp/02366a3VBuS 
	.sect	".text:space"
	.clink
	.global	||space||
...
$C$DW$9	.dwtag  DW_TAG_subprogram, DW_AT_name("space")
	...
	.dwattr $C$DW$9, DW_AT_TI_begin_file("detector.c")
	.dwattr $C$DW$9, DW_AT_TI_begin_line(0x5a)
	.dwattr $C$DW$9, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$9, DW_AT_decl_file("detector.c")
	.dwattr $C$DW$9, DW_AT_decl_line(0x5a)
	.dwattr $C$DW$9, DW_AT_decl_column(0x06)
	.dwattr $C$DW$9, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "detector.c",line 90,column 28,is_stmt,address ||space||,isa 0
...
$C$DW$11	.dwtag  DW_TAG_variable, DW_AT_name("pulses")
	...
	.dwcfi	cfa_offset, 0
	.dwpsn	file "detector.c",line 91,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  91 | __R30 &= ~PRU0_GPIO;                                                   
;----------------------------------------------------------------------
        CLR       r30, r30, 0x00000002  ; [ALU_PRU] |91| 
	.dwpsn	file "detector.c",line 92,column 8,is_stmt,isa 0
;----------------------------------------------------------------------
;  92 | while(pulses > 0){                                                     
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
||$C$L1||:    
	.dwpsn	file "detector.c",line 93,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
...
$1:     SUB      r1, r1, 1
	...
	.dwpsn	file "detector.c",line 94,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
...
$C$DW$12	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$12, DW_AT_TI_return
        JMP       r3.w2                 ; [ALU_PRU] 
	.dwattr $C$DW$9, DW_AT_TI_end_file("detector.c")
...
$C$DW$15	.dwtag  DW_TAG_variable, DW_AT_name("pulses")
	...
	.dwcfi	cfa_offset, 0
	.dwpsn	file "detector.c",line 80,column 8,is_stmt,isa 0
;----------------------------------------------------------------------
;  80 | while(pulses > 0){                                                     
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
||$C$L3||:    
	.dwpsn	file "detector.c",line 81,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
;  81 | __R30 |= PRU0_GPIO;                                                    
;----------------------------------------------------------------------
        SET       r30, r30, 0x00000002  ; [ALU_PRU] |81| 
	.dwpsn	file "detector.c",line 82,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
...
$1:     SUB      r1, r1, 1
	...
	.dwpsn	file "detector.c",line 83,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
;  83 | __R30 ^= PRU0_GPIO;                                                    
;----------------------------------------------------------------------
        XOR       r30, r30, 0x04        ; [ALU_PRU] |83| 
	.dwpsn	file "detector.c",line 84,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
...
$C$DW$16	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$16, DW_AT_TI_return
        JMP       r3.w2                 ; [ALU_PRU] 
	.dwattr $C$DW$13, DW_AT_TI_end_file("detector.c")
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "detector.c",line 102,column 14,is_stmt,isa 0
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
||$C$L5||:    
	.dwpsn	file "detector.c",line 104,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
	.dwpsn	file "detector.c",line 109,column 11,is_stmt,isa 0
;----------------------------------------------------------------------
...
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "detector.c",line 109,column 22,is_stmt,isa 0
;----------------------------------------------------------------------
; 110 | };                                                                     
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
||$C$L6||:    
	.dwpsn	file "detector.c",line 106,column 11,is_stmt,isa 0
...
$C$DW$23	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "detector.c",line 106,column 22,is_stmt,isa 0
...
$C$DW$24	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "detector.c",line 102,column 25,is_stmt,isa 0
        SUB       r15.b0, r15.b0, 0x01  ; [ALU_PRU] |102| $O$L1,$O$L1
	.dwpsn	file "detector.c",line 111,column 9,is_stmt,isa 0
;----------------------------------------------------------------------
; 111 | data <<= 1;                                                            
;----------------------------------------------------------------------
...
$C$DW$25	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$25, DW_AT_TI_return
        JMP       r3.w0                 ; [ALU_PRU] 
	.dwattr $C$DW$17, DW_AT_TI_end_file("detector.c")
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "detector.c",line 148,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
; 148 | __R30 &= ~PRU0_GPIO;                                                   
; 150 | while(1){                                                              
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
||$C$L9||:    
	.dwpsn	file "detector.c",line 151,column 6,is_stmt,isa 0
;----------------------------------------------------------------------
; 151 | mark(171);                                                             
;----------------------------------------------------------------------
...
$C$DW$27	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "detector.c",line 152,column 6,is_stmt,isa 0
;----------------------------------------------------------------------
; 152 | space(171);                                                            
;----------------------------------------------------------------------
...
$C$DW$28	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "detector.c",line 153,column 6,is_stmt,isa 0
;----------------------------------------------------------------------
...
$C$DW$29	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "detector.c",line 154,column 6,is_stmt,isa 0
;----------------------------------------------------------------------
...
$1:     SUB      r17, r17, 1
	...
	.dwpsn	file "detector.c",line 150,column 11,is_stmt,isa 0
        JMP       ||$C$L9||             ; [ALU_PRU] |150| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$26, DW_AT_TI_end_file("detector.c")

...
;* Date/Time created: Sat Apr 14 23:23:22 2018                                *
;******************************************************************************
...
;	optpru /tmp/024998SugFV /tmp/02499AJht9G 
;	acpiapru -@/tmp/02499ObASqR 
	.sect	".text:resetIEP"
	.clink
	.global	||resetIEP||
...
;* --------------------------------------------------------------------------*
||$C$L26||:    
	.dwpsn	file "main1.c",line 271,column 6,is_stmt,isa 0
;----------------------------------------------------------------------
; 271 | if(__R31 & HOST_INT){                                                  
;----------------------------------------------------------------------
        QBBC      ||$C$L28||, r31, 0x1f ; [ALU_PRU] |271| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "main1.c",line 273,column 4,is_stmt,isa 0
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
	.dwpsn	file "main1.c",line 277,column 6,is_stmt,isa 0
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
||$C$L27||:    
	.dwpsn	file "main1.c",line 280,column 6,is_stmt,isa 0
;----------------------------------------------------------------------
